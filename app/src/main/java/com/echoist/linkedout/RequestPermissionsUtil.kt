...
private fun stringToLongitude(longitudeStr: String): String {
    ...
    private val locationListener: LocationListener = object : LocationListener {
        override fun onLocationChanged(location: Location) {
            ...
            viewModel.longitude   =  String.format("%.3f", location.longitude).toDouble() //셋째자리까지 포매팅
            viewModel.latitude =  String.format("%.3f", location.latitude).toDouble()

            Log.d("Location_Lat_Lon", "Latitude: ${viewModel.longitude}, Longitude: ${viewModel.latitude}")
